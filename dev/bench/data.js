    ...
    "Rust Benchmark": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "aa8e60290eab26d82714766f554dcc6a0969b17c",
          "message": "🐛 fix(Excel预览): 兼容多格式并隐藏工作表\n\n- 改用自动识别文件格式，修复 xls 解析失败\n- 通过元数据识别隐藏/极隐藏工作表，默认跳过\n- 仅在支持的格式下保留样式和合并单元格\n- xls 预览改为仅显示纯文本，避免异常解析",
          "timestamp": "2026-03-20T16:39:10+08:00",
          "tree_id": "b5a82aa2c29cf5a512024d56575e45ec87419ffc",
          "url": "https://github.com/kurisu994/belobog-stellar-grid/commit/aa8e60290eab26d82714766f554dcc6a0969b17c"
        },
        "date": 1773996162787,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "9b92025391a263f90f6c4ab34eeb18c55fb8b96d",
          "message": "chore: bump version to 1.1.5",
          "timestamp": "2026-03-20T16:40:12+08:00",
          "tree_id": "47928ff712afda3c47970410c10c6798983bbbc0",
          "url": "https://github.com/kurisu994/belobog-stellar-grid/commit/9b92025391a263f90f6c4ab34eeb18c55fb8b96d"
        },
        "date": 1773996212632,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "29e59aaedb74978df02a865973a2869c9c2b0b49",
          "message": "feat: Enhance Excel HTML preview with default cell text wrapping and compensatory styling for XLS files.",
          "timestamp": "2026-03-20T17:58:14+08:00",
          "tree_id": "39412e7201dfe7266d5b55f40af716a74bdfc5ee",
          "url": "https://github.com/kurisu994/belobog-stellar-grid/commit/29e59aaedb74978df02a865973a2869c9c2b0b49"
        },
        "date": 1774000910634,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "58a15b3120cf1ea964aca86bb95b7a56af226456",
          "message": "chore: bump version to 1.1.6",
          "timestamp": "2026-03-20T17:58:32+08:00",
          "tree_id": "069a1ecfe087c9245958011a793de8e646fd5046",
          "url": "https://github.com/kurisu994/belobog-stellar-grid/commit/58a15b3120cf1ea964aca86bb95b7a56af226456"
        },
        "date": 1774000918741,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "11125daaf32e09a96bd52f84f39e927eb07d5c9b",
          "message": "🐛 fix(数据导出): 优化单元格解析与防止溢出\n- 合并属性读取优化，减少JS Reflect调用\n- 限制行列跨度范围，防止溢出\n- 增加对无效颜色值的校验，防止CSS注入\n- 增加对CSV注入的防护，扩展检测字符",
          "timestamp": "2026-03-21T11:09:41+08:00",
          "tree_id": "3f56c8a712d1135623fb931e1b7778e41cc6683e",
          "url": "https://github.com/kurisu994/belobog-stellar-grid/commit/11125daaf32e09a96bd52f84f39e927eb07d5c9b"
        },
        "date": 1774062793527,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "3aedeb9bd923b32504651560d89bc78987ade2c2",
          "message": "🐛 fix(excel): 修复样式计算溢出并优化表格解析逻辑\n\n修复颜色计算中可能出现的浮点溢出问题，添加数值范围限制\n优化Excel解析器中的行号处理逻辑，移除冗余变量\n为表格导出添加表头行数统计，支持后续样式区分\n重构边框类型解析方法，实现FromStr trait以提升代码一致性",
          "timestamp": "2026-03-21T11:22:13+08:00",
          "tree_id": "8a0135fb52f868a776d0f28f167a59ff6c28987e",
          "url": "https://github.com/kurisu994/belobog-stellar-grid/commit/3aedeb9bd923b32504651560d89bc78987ade2c2"
        },
        "date": 1774063539941,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "978d161de78f18f244c7f8e8a5c787532f7ca762",
          "message": "📝 docs(project): 更新项目规则文档和测试说明\n\n同步项目结构变更，新增 Excel 预览、样式系统和流式导出模块\n更新测试数量从 103 个增加到 190 个\n添加 Svelte、Solid.js 和 Web Worker 子包支持\n修复批量 XLSX 导出的表头行数计算问题\n优化颜色计算和样式解析实现",
          "timestamp": "2026-03-21T11:30:30+08:00",
          "tree_id": "10645cda938df3e2f152426f8c5beef28581a6e8",
          "url": "https://github.com/kurisu994/belobog-stellar-grid/commit/978d161de78f18f244c7f8e8a5c787532f7ca762"
        },
        "date": 1774064040586,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "3d9a656f2726161f1bbece3742c06a7398518b2c",
          "message": "📝 docs: 更新测试统计与项目文档\n\n- 同步单元测试与 E2E 测试数量，避免文档过时\n- 补充新增示例、预览能力和目录结构说明\n- 调整测试分布说明，便于快速定位相关用例",
          "timestamp": "2026-03-23T10:53:51+08:00",
          "tree_id": "7a49ab1a4c3ab32ade42b0db3807ef1fd476da67",
          "url": "https://github.com/kurisu994/belobog-stellar-grid/commit/3d9a656f2726161f1bbece3742c06a7398518b2c"
        },
        "date": 1774234636837,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "b56bc17dc7e5353fd37a631a6fdfa4b557d74c2a",
          "message": "chore: bump version to 1.1.8",
          "timestamp": "2026-03-25T16:07:52+08:00",
          "tree_id": "23c5e8187a32b97fd5b95ddbaf1645c91540455f",
          "url": "https://github.com/kurisu994/belobog-stellar-grid/commit/b56bc17dc7e5353fd37a631a6fdfa4b557d74c2a"
        },
        "date": 1774426270925,
        "tool": "cargo",
        "benches": [
