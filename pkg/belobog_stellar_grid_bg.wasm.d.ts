...
export const getExcelSheetList: (a: number, b: number) => [number, number, number];
export const parseExcelToHtml: (a: number, b: number, c: any) => [number, number, number];
export const parseExcelToJson: (a: number, b: number, c: any) => [number, number, number];
export const wasm_bindgen__closure__destroy__hb1f1e222d193ce94: (a: number, b: number) => void;
export const wasm_bindgen__closure__destroy__h0da2cc159b2ccb90: (a: number, b: number) => void;
export const wasm_bindgen__convert__closures_____invoke__h4c21a5017d209281: (a: number, b: number, c: any) => [number, number];
export const wasm_bindgen__convert__closures_____invoke__h00d297b34697abe8: (a: number, b: number, c: any, d: any) => void;
export const wasm_bindgen__convert__closures_____invoke__h7ba64efaccb10351: (a: number, b: number) => void;
