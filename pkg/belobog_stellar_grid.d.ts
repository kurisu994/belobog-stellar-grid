...
export interface InitOutput {
    ...
    readonly wasm_bindgen__closure__destroy__hc8a49241b11bcdf0: (a: number, b: number) => void;
    ...
    readonly wasm_bindgen__convert__closures_____invoke__h13f4fda92ac6bfee: (a: number, b: number) => void;
