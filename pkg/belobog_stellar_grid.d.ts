...
export interface InitOutput {
    ...
    readonly wasm_bindgen__closure__destroy__h0da2cc159b2ccb90: (a: number, b: number) => void;
    ...
    readonly wasm_bindgen__convert__closures_____invoke__h7ba64efaccb10351: (a: number, b: number) => void;
