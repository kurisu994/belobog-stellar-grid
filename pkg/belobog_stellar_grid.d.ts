...
export interface InitOutput {
    ...
    readonly wasm_bindgen__closure__destroy__h47a02344c072fbfb: (a: number, b: number) => void;
    ...
    readonly wasm_bindgen__convert__closures_____invoke__h493839daf82ac541: (a: number, b: number) => void;
