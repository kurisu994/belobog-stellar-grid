...
export interface InitOutput {
    ...
    readonly wasm_bindgen__closure__destroy__hdabd884f38b69116: (a: number, b: number) => void;
    ...
    readonly wasm_bindgen__convert__closures_____invoke__h1bdbb997274fbac9: (a: number, b: number) => void;
